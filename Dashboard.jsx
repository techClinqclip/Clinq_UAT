...
export default function ClipperDashboard() {
    ...
    if (loading) {
        return (
            <div className="rounded-3xl border border-white/10 bg-[#0B0B12] p-8 text-white">
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <span className="rounded-full bg-green-500/10 px-2 py-1 text-xs font-medium text-green-400">+12%</span>
                            </div>
                        ...
                        <tbody>
                            {recentSubmissions.map((submission) => (
                                <tr key={submission.id} className="border-b border-white/5 transition hover:bg-white/[0.02]">
                                    ...
                                    <td className="py-5 font-semibold text-green-400">{formatRupees(submission.earnings)}</td>
