...
export default function MarketplaceLayout({
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      {/* Backdrop */}
      <div
        className={`fixed inset-0 z-40 bg-black/60 backdrop-blur-[2px] transition-opacity duration-300 xl:hidden ${
          sidebarOpen
      ...
      {/* Drawer */}
      <aside
        className={`fixed inset-y-0 right-0 z-50 w-[88%] max-w-sm border-l border-white/10 bg-[#0B0B12] shadow-2xl transition-transform duration-300 ease-out xl:hidden ${
      ...
      <button
        ...
        className={`fixed right-0 top-1/2 z-30 flex h-14 w-8 -translate-y-1/2 items-center justify-center rounded-l-xl border border-r-0 border-white/10 bg-[#16161F]/95 text-zinc-400 shadow-xl backdrop-blur-xl transition-all duration-300 hover:bg-violet-600 hover:text-white xl:hidden ${
          sidebarOpen
